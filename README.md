...
- [LND](https://github.com/lightningnetwork/lnd) - v0.12.1, v0.12.0, v0.11.1, v0.11.0, v0.10.3, v0.10.2, v0.10.1, v0.10.0, v0.9.1, v0.9.0, v0.8.2, v0.8.0 & v0.7.1
- [c-lightning](https://github.com/ElementsProject/lightning) - v0.10.0, v0.9.3, v0.9.2, v0.9.1, v0.9.0, v0.8.2, v0.8.1 & v0.8.0
- [Eclair](https://github.com/ACINQ/eclair/) - v0.6.0, v0.5.0, v0.4.2, v0.3.3
