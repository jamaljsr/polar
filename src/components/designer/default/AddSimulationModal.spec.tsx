...
// Mock only the hasChartLink function using jest.spyOn
const mockHasChartLink = jest.fn();

describe('AddSimulationModal', () => {
  let unmount: () => void;
  let hasChartLinkSpy: jest.SpyInstance;
  ...
  beforeEach(() => {
    hasChartLinkSpy = jest.spyOn(chartUtils, 'hasChartLink');
    hasChartLinkSpy.mockImplementation(mockHasChartLink);
    mockHasChartLink.mockReturnValue(true);
  });
